...
public class BlindAssistantActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setSpeechLabel("Vyhledat pomoc");
        ...
        btn3.setOnDoubleClickListener(new OnDoubleClickListener() {
			...
			public void onDoubleClick() {
				// TODO Auto-generated method stub
				SpeechHelper.getInstance().say("Předčítám souhrnné informace.    Délka účasti v programu pro sledování polohy           15dní. Během vaší účasti jste celkem osmkrát využil možnost vyhledání cizí pomoci.", getApplicationContext(), SpeechHelper.STANDARD_MSG);
			}
		});
        
        BlindButton btn4 = (BlindButton) findViewById(R.id.fourthButton);
        btn4.setSpeechLabel("monitorovací sekce");
        btn4.setText("monitorovací sekce");
        btn4.setActionSpeechLabel("pozor - opouštíte rozhraní pro zrakově postižené");
